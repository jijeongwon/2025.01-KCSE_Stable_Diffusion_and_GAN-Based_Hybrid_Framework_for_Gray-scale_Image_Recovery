...
def visualize_predictions(val_loader, generator, device, epoch, num_samples=4):
    ...
    with torch.no_grad():
        for i, (input_images, gt_images) in enumerate(val_loader):
            ...
            # 그래프를 고해상도로 저장
            plt.savefig(f'output_prompt_1/validation_epoch_{epoch}.png', dpi=300)  # 고해상도 저장
            plt.show()
...
input_dir = "/home/work/jun/train_output_1"
gt_dir = "/home/work/.sina/Ptrain_gt"

val_input_dir = "/home/work/jun/val_output_1"
...
for epoch in range(epochs):
    ...
    # Save loss graph
    save_loss_graph(train_losses_G, val_losses_G, epoch+1, filename=f'output_prompt_1/loss_epoch_{epoch+1}.png')
    ...
    test_input_dir = "/home/work/jun/test_output_1"
    output_dir = f"prompt_1_output_images_epoch_{epoch+1}"
