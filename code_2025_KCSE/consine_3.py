...
def visualize_predictions(val_loader, generator, device, epoch, num_samples=4):
    ...
    with torch.no_grad():
        for i, (input_images, gt_images) in enumerate(val_loader):
            ...
            # 그래프를 고해상도로 저장
            plt.savefig(f'output_prompt_3/validation_epoch_{epoch}.png', dpi=300)  # 고해상도 저장
            plt.show()
...
input_dir = "/home/work/.Gmama/train_output_3"
gt_dir = "/home/work/.sina/Ptrain_gt"

val_input_dir = "/home/work/.Gmama/val_output_3"
...
checkpoint_path = "checkpoint_prompt_3.pth"
...
for epoch in range(epochs):
    ...
    # Save loss graph
    save_loss_graph(train_losses_G, val_losses_G, epoch+1, filename=f'output_prompt_3/loss_epoch_{epoch+1}.png')
    ...
    test_input_dir = "/home/work/.Gmama/test_output_3"
    output_dir = f"prompt_3_output_images_epoch_{epoch+1}"
